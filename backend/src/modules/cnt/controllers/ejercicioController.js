const s = require('../services/ejercicioService');
...
const create  = async (req, res, next) => {
  try {
    if (!req.body.ej_fec_inicial || !req.body.ej_fec_final) return res.status(400).json({ message: 'Las fechas inicial y final son requeridas' });
