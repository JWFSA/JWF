...
const updateLinea        = async (req, res, next) => { try { res.json(await s.updateLinea(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteLinea        = async (req, res, next) => { try { await s.deleteLinea(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateMarca        = async (req, res, next) => { try { res.json(await s.updateMarca(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteMarca        = async (req, res, next) => { try { await s.deleteMarca(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateRubro        = async (req, res, next) => { try { res.json(await s.updateRubro(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteRubro        = async (req, res, next) => { try { await s.deleteRubro(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateGrupo        = async (req, res, next) => { try { res.json(await s.updateGrupo(Number(req.params.linea), Number(req.params.codigo), req.body)); } catch (e) { next(e); } };
const deleteGrupo        = async (req, res, next) => { try { await s.deleteGrupo(Number(req.params.linea), Number(req.params.codigo)); res.status(204).end(); } catch (e) { next(e); } };
