...
// Bancos
const getBancos      = async (req, res, next) => { try { res.json(await s.getBancos({ all: req.query.all === 'true', page: parseInt(req.query.page) || 1, limit: parseInt(req.query.limit) || 20, search: req.query.search || '' })); } catch (e) { next(e); } };
...
// Formas de pago
const getFormasPago    = async (req, res, next) => { try { res.json(await s.getFormasPago({ all: req.query.all === 'true', page: parseInt(req.query.page) || 1, limit: parseInt(req.query.limit) || 20, search: req.query.search || '' })); } catch (e) { next(e); } };
...
// Ramos
const getRamos      = async (req, res, next) => { try { res.json(await s.getRamos({ all: req.query.all === 'true', page: parseInt(req.query.page) || 1, limit: parseInt(req.query.limit) || 20, search: req.query.search || '' })); } catch (e) { next(e); } };
...
// Tipos de proveedor
const getTiposProveedor    = async (req, res, next) => { try { res.json(await s.getTiposProveedor({ all: req.query.all === 'true', page: parseInt(req.query.page) || 1, limit: parseInt(req.query.limit) || 20, search: req.query.search || '' })); } catch (e) { next(e); } };
