...
const updateBanco    = async (req, res, next) => { try { res.json(await s.updateBanco(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteBanco    = async (req, res, next) => { try { await s.deleteBanco(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateFormaPago  = async (req, res, next) => { try { res.json(await s.updateFormaPago(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteFormaPago  = async (req, res, next) => { try { await s.deleteFormaPago(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateRamo    = async (req, res, next) => { try { res.json(await s.updateRamo(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteRamo    = async (req, res, next) => { try { await s.deleteRamo(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateTipoProveedor  = async (req, res, next) => { try { res.json(await s.updateTipoProveedor(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteTipoProveedor  = async (req, res, next) => { try { await s.deleteTipoProveedor(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updatePersoneria  = async (req, res, next) => { try { res.json(await s.updatePersoneria(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deletePersoneria  = async (req, res, next) => { try { await s.deletePersoneria(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
...
const updateClaseDoc  = async (req, res, next) => { try { res.json(await s.updateClaseDoc(Number(req.params.id), req.body)); } catch (e) { next(e); } };
const deleteClaseDoc  = async (req, res, next) => { try { await s.deleteClaseDoc(Number(req.params.id)); res.status(204).end(); } catch (e) { next(e); } };
