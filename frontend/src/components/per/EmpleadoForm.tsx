...
export default function EmpleadoForm({ initial, onSave, isPending, error }: Props) {
  ...
  const defaults: FormData = {
    ...
    empl_sexo: initial?.empl_sexo ?? '',
    empl_est_civil: initial?.empl_est_civil ?? '',
    ...
    empl_cobra_comision: initial?.empl_cobra_comision ?? 'N',
    empl_bonif_fliar: initial?.empl_bonif_fliar ?? 'N',
    empl_ind_anticipos: initial?.empl_ind_anticipos ?? 'N',
    ...
    empl_tipo_horar: initial?.empl_tipo_horar ?? '',
    empl_tiempo_alm: initial?.empl_tiempo_alm ?? null,
    empl_desc_tiemp_alm: initial?.empl_desc_tiemp_alm ?? 'N',
    empl_calc_hr_ext: initial?.empl_calc_hr_ext ?? 'N',
    empl_lim_lleg_temp: initial?.empl_lim_lleg_temp ?? null,
    empl_ind_trab_sab: initial?.empl_ind_trab_sab ?? 'N',
    ...
    empl_situacion_ips: initial?.empl_situacion_ips ?? '',
