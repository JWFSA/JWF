...
import type { Sistema } from '@/types/gen';
import { Globe, CheckCircle, XCircle } from 'lucide-react';
import DataTable from '@/components/ui/DataTable';

const COLUMNS = [
  { key: 'codigo', header: 'Código', headerClassName: 'w-24', cell: (s: Sistema) => s.sist_codigo, cellClassName: 'font-mono text-xs text-gray-500' },
  ...
  { key: 'abrev',  header: 'Abrev.', headerClassName: 'hidden sm:table-cell', cell: (s: Sistema) => s.sist_desc_abrev, cellClassName: 'text-gray-500 hidden sm:table-cell' },
  { key: 'estado', header: 'Estado',
    cell: (s: Sistema) => s.sist_ind_habilitado === 'S'
