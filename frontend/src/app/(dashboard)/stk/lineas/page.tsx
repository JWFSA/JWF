    ...
    <div className="p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        ...
        <button onClick={openNueva} className="inline-flex items-center gap-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition">
          <Plus size={16} /><span className="hidden sm:inline">Nueva línea</span><span className="sm:hidden">Nueva</span>
        </button>
      </div>
      ...
      {modal !== null && (
        <Modal title={modal === 'nueva' ? 'Nueva línea' : `Editar: ${(modal as Linea).lin_desc}`} onClose={() => setModal(null)}>
